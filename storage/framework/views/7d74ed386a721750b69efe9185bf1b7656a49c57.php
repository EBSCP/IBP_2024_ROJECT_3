        ...
        <div class="collapse navbar-collapse" id="navbarSupport">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item active">
              <a class="nav-link" href="<?php echo e(url('doctor')); ?>">Home</a>
            </li>
            <li class="nav-item">
...
<?php /**PATH C:\Users\ertug\Desktop\2110213017_1\hospital_management\resources\views/user/header.blade.php ENDPATH**/ ?>